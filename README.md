...
- **5tratSmack** (`willitmod-dev-5tratsmack`) - `0.10.0-dev.1` (pre-launch; mining opens at candidate block 1000)
- **PowPow** (`willitmod-dev-powpow`) - `0.2.30-dev`
...
2. Point miners at:
   ...
   - 5TRAT (after candidate block 1000 opens): `stratum+tcp://<host-ip>:57557`
